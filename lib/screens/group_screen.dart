                ...
                onTap: () async {
                  try {
                    if (changedUserName != null && changedUserName != "") {
                      ...
                      await groups.where('users',arrayContains: userName).get()
                          .then((value) => {
                            value.docs.forEach((element) {
                              List<dynamic> temporary = element.get('users');
                              temporary.remove(userName);
                              temporary.add(changedUserName);
                              groups.doc(element.id).update({'users': temporary});
                            })
                      });
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => GroupMemberScreen(groupName: groupName,)
          ),
        );
      },
